...
class Slider {
  ...
  constructor(rootElement) {
    ...
    this.previousButtonElemetn = this.navigationElement.querySelector(this.selectors.previousButton)
    this.nextButtonElemetn = this.navigationElement.querySelector(this.selectors.nextButton)
    this.paginationElemetn = this.navigationElement.querySelector(this.selectors.pagination)
  ...
  init() {
    new Swiper(this.swiperElement, {
      ...
      navigation: {
        prevEl: this.previousButtonElemetn,
        nextEl: this.nextButtonElemetn
      },
      pagination: {
        el: this.paginationElemetn,
